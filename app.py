...
st.set_page_config(page_title="NetSage AI", page_icon=LOGO_PATH if os.path.exists(LOGO_PATH) else "🧠", layout="wide")

col_logo, col_title = st.columns([0.8, 9.2])
with col_logo:
    if os.path.exists(LOGO_PATH):
        st.image(LOGO_PATH, width=80)
with col_title:
    st.title("NetSage AI")
    st.caption("AI-Assisted Cisco Network Troubleshooting System — Deva Raj Bhojanapu")
